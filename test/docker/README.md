...
Configure your public key for connecting to the VM as described in the section about secrets in [/docs/user-manual/important-concepts.md](../../docs/user-manual/important-concepts.md).
