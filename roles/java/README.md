...
| --- | --- | --- |
| `login_user_names` | *(required)* | List of local usernames to install sdkman and the JDK for. Must contain at least one name; the role fails loudly if it is undefined or empty. |
